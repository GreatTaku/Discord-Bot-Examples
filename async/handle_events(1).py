...
async def on_channel_create(channel):
    """
    This event is called when any channel is created.

    This can be called for server channel, group private channel or direct private channel.

    Args:
        channel:
            The Channel object of the created channel.
...
async def on_channel_delete(channel):
    """
    This event is called when any channel is deleted.
...
async def on_channel_update(before, after):
    """
    This event is called when any channel is updated.
    ...
    Args:
        before:
            The Channel object of the original channel.
        after:
            The Channel object of the updated channel.
